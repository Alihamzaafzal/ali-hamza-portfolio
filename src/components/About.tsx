              ...
              <div className="rounded-[28px] border border-white/12 bg-[#111318] p-8 shadow-[0_12px_36px_rgba(0,0,0,0.5)]">
                ...
                <div className="mt-8 grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={stat.label}
                      className="stat-glow-pill rounded-2xl border border-white/10 bg-[#0C0C0C]/80 p-4 text-center transition-all duration-300 hover:border-white/20 hover:bg-[#0C0C0C]"
                    >
